# Graph Report - bibliotheque  (2026-08-18)

## Corpus Check
- 168 files · ~53,127 words
...
Cohesion: 0.22
Nodes (9): @heroui/react, @heroui/styles, monaco-editor, dependencies, @heroui/react, @heroui/styles, monaco-editor, rehype-pretty-code (+1 more)
...
- **Why does `dependencies` connect `dependencies` to `devDependencies`, `clsx`, `@codesandbox/sandpack-react`, `@hookform/resolvers`, `@monaco-editor/react`, `next`, `nuqs`, `@phosphor-icons/react`, `react`, `react-aria`, `react-aria-components`, `@react-aria/i18n`, `@react-aria/ssr`, `@react-aria/utils`, `react-dom`, `bcryptjs`, `shiki`, `tailwind-variants`, `zod`, `@ai-sdk/openai-compatible`, `ai`, `next-mdx-remote`, `react-hook-form`, `remark-gfm`, `better-auth`, `dotenv`, `pg`, `@prisma/adapter-pg`, `@prisma/client`, `@swc/helpers`?**
